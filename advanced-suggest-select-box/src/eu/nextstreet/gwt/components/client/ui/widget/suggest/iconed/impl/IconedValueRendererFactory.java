...
public class IconedValueRendererFactory<T, W extends IconedValueHolderItem<T>>
	...
	public IconedValueRendererFactory(StringFormulator<T> stringFormulator,
	...
	public W createValueRenderer(T value, String filterText,
		...
		EventHandlingValueHolderItem<T> label = (EventHandlingValueHolderItem<T>) textRendererFactory
				.createValueRenderer(value, filterText, options);
		@SuppressWarnings("unchecked")
		W toReturn = (W) new IconedValueRenderer<T>(value, icon, label, filterText,
